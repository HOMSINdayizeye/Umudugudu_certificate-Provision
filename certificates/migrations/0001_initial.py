# Generated by Django 4.2.25 on 2025-11-10 22:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cert_type', models.CharField(choices=[('conduct', 'Conduct'), ('residence', 'Residence Recognition'), ('community', 'Community Engagement'), ('Stolen Computer', 'Stolen Computer'), ('other', 'Other')], max_length=20)),
                ...
                ('email', models.EmailField(default='umudugudu@gmail.com', max_length=254)),
